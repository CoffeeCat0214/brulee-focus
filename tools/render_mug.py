#!/usr/bin/env python3
"""Render the Brûlée Focus mug: four sprite layers plus the popup's vector paths.
...
# ── Palette ──────────────────────────────────────────────────────────────────
# Sampled from assets/source/brulee-buddy-master.png. The cat is NOT pixel
...
globalThis.BRULEE_MUG = Object.freeze({{
